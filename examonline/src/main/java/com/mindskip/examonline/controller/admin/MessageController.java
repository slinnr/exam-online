...
import com.mindskip.examonline.service.MessageService;
...
import com.mindskip.examonline.viewmodel.admin.message.MessageResponseVM;
import com.mindskip.examonline.viewmodel.admin.message.MessageSendVM;
...
public class MessageController extends BaseApiController {
     ...
     * @param model
     * @Description:消息通知列表
     * @return com.mindskip.examonline.base.RestResponse<com.github.pagehelper.PageInfo < com.mindskip.examonline.viewmodel.admin.message.MessageResponseVM>>
     */
